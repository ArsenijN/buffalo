...
public class TransferFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private TransferFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private TransferFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static TransferFragmentArgs fromBundle(@NonNull Bundle bundle) {
    TransferFragmentArgs __result = new TransferFragmentArgs();
    ...
    if (bundle.containsKey("videoCodec")) {
      int videoCodec;
      videoCodec = bundle.getInt("videoCodec");
      __result.arguments.put("videoCodec", videoCodec);
    } else {
      throw new IllegalArgumentException("Required argument \"videoCodec\" is missing and does not have an android:defaultValue");
    }
  ...
  public boolean equals(Object object) {
    ...
    TransferFragmentArgs that = (TransferFragmentArgs) object;
  ...
  public static class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(TransferFragmentArgs original) {
      this.arguments.putAll(original.arguments);
    }

    @SuppressWarnings("unchecked")
    public Builder(@NonNull String cameraId, int width, int height, int fps, long dynamicRange,
        int colorSpace, boolean previewStabilization, boolean useMediaRecorder, int videoCodec,
        boolean filterOn) {
      if (cameraId == null) {
        throw new IllegalArgumentException("Argument \"camera_id\" is marked as non-null but was passed a null value.");
      }
    ...
    @NonNull
    public TransferFragmentArgs build() {
      TransferFragmentArgs result = new TransferFragmentArgs(arguments);
      return result;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public Builder setVideoCodec(int videoCodec) {
      this.arguments.put("videoCodec", videoCodec);
      return this;
    }
