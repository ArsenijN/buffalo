...
public class TransferFragmentDirections {
  ...
  @NonNull
  public static ActionTransferToPreview actionTransferToPreview(@NonNull String cameraId, int width,
      ...
      int transfer) {
    return new ActionTransferToPreview(cameraId, width, height, fps, dynamicRange, colorSpace, previewStabilization, useMediaRecorder, videoCodec, filterOn, useHardware, transfer);
  }

  public static class ActionTransferToPreview implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionTransferToPreview(@NonNull String cameraId, int width, int height, int fps,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionTransferToPreview setCameraId(@NonNull String cameraId) {
      if (cameraId == null) {
        throw new IllegalArgumentException("Argument \"camera_id\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("camera_id", cameraId);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionTransferToPreview setWidth(int width) {
      this.arguments.put("width", width);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionTransferToPreview setHeight(int height) {
      this.arguments.put("height", height);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionTransferToPreview setFps(int fps) {
      this.arguments.put("fps", fps);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionTransferToPreview setDynamicRange(long dynamicRange) {
      this.arguments.put("dynamicRange", dynamicRange);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionTransferToPreview setColorSpace(int colorSpace) {
      this.arguments.put("colorSpace", colorSpace);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionTransferToPreview setPreviewStabilization(boolean previewStabilization) {
      this.arguments.put("previewStabilization", previewStabilization);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionTransferToPreview setUseMediaRecorder(boolean useMediaRecorder) {
      this.arguments.put("useMediaRecorder", useMediaRecorder);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionTransferToPreview setVideoCodec(int videoCodec) {
      this.arguments.put("videoCodec", videoCodec);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionTransferToPreview setFilterOn(boolean filterOn) {
      this.arguments.put("filterOn", filterOn);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionTransferToPreview setUseHardware(boolean useHardware) {
      this.arguments.put("useHardware", useHardware);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionTransferToPreview setTransfer(int transfer) {
      this.arguments.put("transfer", transfer);
      return this;
    }
    ...
    public int getActionId() {
      return R.id.action_transfer_to_preview;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionTransferToPreview that = (ActionTransferToPreview) object;
    ...
    public String toString() {
      return "ActionTransferToPreview(actionId=" + getActionId() + "){"
