...
public class EncodeApiFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private EncodeApiFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private EncodeApiFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static EncodeApiFragmentArgs fromBundle(@NonNull Bundle bundle) {
    EncodeApiFragmentArgs __result = new EncodeApiFragmentArgs();
    bundle.setClassLoader(EncodeApiFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    EncodeApiFragmentArgs that = (EncodeApiFragmentArgs) object;
  ...
  public static class Builder {
    ...
    @NonNull
    public EncodeApiFragmentArgs build() {
      EncodeApiFragmentArgs result = new EncodeApiFragmentArgs(arguments);
      return result;
    }
