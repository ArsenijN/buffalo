...
public class ColorSpaceFragmentDirections {
  private ColorSpaceFragmentDirections() {
  }

  @NonNull
  public static ActionColorSpaceToPreviewStabilization actionColorSpaceToPreviewStabilization(
      @NonNull String cameraId, int width, int height, int fps, long dynamicRange, int colorSpace) {
    return new ActionColorSpaceToPreviewStabilization(cameraId, width, height, fps, dynamicRange, colorSpace);
  }

  @NonNull
  public static ActionColorSpaceToEncodeApi actionColorSpaceToEncodeApi(@NonNull String cameraId,
      int width, int height, int fps, long dynamicRange, int colorSpace,
      boolean previewStabilization) {
    return new ActionColorSpaceToEncodeApi(cameraId, width, height, fps, dynamicRange, colorSpace, previewStabilization);
  }

  public static class ActionColorSpaceToPreviewStabilization implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionColorSpaceToPreviewStabilization(@NonNull String cameraId, int width, int height,
        int fps, long dynamicRange, int colorSpace) {
      if (cameraId == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionColorSpaceToPreviewStabilization setCameraId(@NonNull String cameraId) {
      if (cameraId == null) {
        throw new IllegalArgumentException("Argument \"camera_id\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("camera_id", cameraId);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionColorSpaceToPreviewStabilization setWidth(int width) {
      this.arguments.put("width", width);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionColorSpaceToPreviewStabilization setHeight(int height) {
      this.arguments.put("height", height);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionColorSpaceToPreviewStabilization setFps(int fps) {
      this.arguments.put("fps", fps);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionColorSpaceToPreviewStabilization setDynamicRange(long dynamicRange) {
      this.arguments.put("dynamicRange", dynamicRange);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionColorSpaceToPreviewStabilization setColorSpace(int colorSpace) {
      this.arguments.put("colorSpace", colorSpace);
      return this;
    }
    ...
    public int getActionId() {
      return R.id.action_color_space_to_preview_stabilization;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionColorSpaceToPreviewStabilization that = (ActionColorSpaceToPreviewStabilization) object;
    ...
    public String toString() {
      return "ActionColorSpaceToPreviewStabilization(actionId=" + getActionId() + "){"
  ...
  public static class ActionColorSpaceToEncodeApi implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionColorSpaceToEncodeApi(@NonNull String cameraId, int width, int height, int fps,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionColorSpaceToEncodeApi setCameraId(@NonNull String cameraId) {
      if (cameraId == null) {
        throw new IllegalArgumentException("Argument \"camera_id\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("camera_id", cameraId);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionColorSpaceToEncodeApi setWidth(int width) {
      this.arguments.put("width", width);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionColorSpaceToEncodeApi setHeight(int height) {
      this.arguments.put("height", height);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionColorSpaceToEncodeApi setFps(int fps) {
      this.arguments.put("fps", fps);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionColorSpaceToEncodeApi setDynamicRange(long dynamicRange) {
      this.arguments.put("dynamicRange", dynamicRange);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionColorSpaceToEncodeApi setColorSpace(int colorSpace) {
      this.arguments.put("colorSpace", colorSpace);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionColorSpaceToEncodeApi setPreviewStabilization(boolean previewStabilization) {
      this.arguments.put("previewStabilization", previewStabilization);
      return this;
    }
    ...
    @Override
    public int getActionId() {
      return R.id.action_color_space_to_encode_api;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionColorSpaceToEncodeApi that = (ActionColorSpaceToEncodeApi) object;
      if (arguments.containsKey("camera_id") != that.arguments.containsKey("camera_id")) {
        return false;
      }
      if (getCameraId() != null ? !getCameraId().equals(that.getCameraId()) : that.getCameraId() != null) {
    ...
    @Override
    public String toString() {
      return "ActionColorSpaceToEncodeApi(actionId=" + getActionId() + "){"
          + "cameraId=" + getCameraId()
          + ", width=" + getWidth()
          + ", height=" + getHeight()
          + ", fps=" + getFps()
