...
public class ColorSpaceFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private ColorSpaceFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private ColorSpaceFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static ColorSpaceFragmentArgs fromBundle(@NonNull Bundle bundle) {
    ColorSpaceFragmentArgs __result = new ColorSpaceFragmentArgs();
    bundle.setClassLoader(ColorSpaceFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    ColorSpaceFragmentArgs that = (ColorSpaceFragmentArgs) object;
  ...
  public static class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(ColorSpaceFragmentArgs original) {
    ...
    @NonNull
    public ColorSpaceFragmentArgs build() {
      ColorSpaceFragmentArgs result = new ColorSpaceFragmentArgs(arguments);
      return result;
    }
